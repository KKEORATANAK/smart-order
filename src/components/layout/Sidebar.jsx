      ...
      <div className="h-screen overflow-hidden">
        <aside className="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
          <nav className="flex flex-1 flex-col gap-y-4 pt-10">
            ...
            <a
              href="#"
              className="text-gray-400 group relative rounded-xl p-2 hover:bg-gray-50"
            >
              <svg
                width="24"
                height="24"
              ...
              >
                ...
                />
                <path
                  d="M7.5 11C7.77614 11 8 10.7761 8 10.5C8 10.2239 7.77614 10 7.5 10C7.22386 10 7 10.2239 7 10.5C7 10.77614 7.22386 11 7.5 11Z"
                  fill="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                />
                <path
                  d="M16.5 11C16.7761 11 17 10.7761 17 10.5C17 10.2239 16.7761 10 16.5 10C16.2239 10 16 10.2239 16 10.5C16 10.77614 16.2239 11 16.5 11Z"
                  fill="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
